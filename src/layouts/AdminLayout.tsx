...
import { Bell, Menu, LogOut, ChevronDown, Shield } from "lucide-react";
      ...
      <div className={cn("transition-all duration-200", collapsed ? "ml-16" : "ml-60")}>
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Notification bell */}
            <button className="relative text-white/80 hover:text-white hover:bg-white/15 transition-all p-2 rounded-lg">
              <Bell className="h-5 w-5" />
              <span className="absolute -top-0.5 -right-0.5 h-4 w-4 rounded-full bg-orange-400 text-white text-[9px] flex items-center justify-center font-bold shadow">3</span>
            </button>
