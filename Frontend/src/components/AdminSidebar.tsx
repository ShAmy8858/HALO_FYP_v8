...
import {
  ...
  Settings, User, LogOut, Receipt
} from "lucide-react";

const navItems = [
  { title: "Dashboard", path: "/admin", icon: LayoutDashboard },
  { title: "Applications", path: "/admin/applications", icon: FileText, badgeKey: "pendingApplications" as const },
  { title: "Hospitals", path: "/admin/hospitals", icon: Building2 },
  { title: "Subscription", path: "/admin/subscriptions", icon: CreditCard },
  { title: "Payment Reviews", path: "/admin/payment-reviews", icon: Receipt },
...
export function AdminSidebar({ collapsed, onToggle, pendingApplications = 0 }: AdminSidebarProps) {
