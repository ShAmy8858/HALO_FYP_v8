...
const plans = [
  ...
  {
    name: "Enterprise", price: "PKR 29,999", period: "/month", highlight: false,
    ...
    <nav className={`lp-nav ${scrolled ? "lp-nav--scrolled" : ""}`}>
      <div className="lp-nav__inner">
        ...
        <div className="lp-nav__actions">
          ...
          <button className="lp-nav__link" onClick={() => navigate("/application-status")} style={{ fontSize: '13px' }}>Track Registration Status</button>
      ...
      {mobileOpen && (
        <div className="lp-nav__mobile">
          ...
          <div className="lp-nav__mobile-actions">
            <button className="lp-nav__link" onClick={() => { setMobileOpen(false); navigate("/application-status"); }} style={{ textAlign: 'center', padding: '8px 0', fontSize: '14px' }}>Track Registration Status</button>
          ...
          <div className="lp-pricing-grid">
            {plans.map((p, i) => (
              <div key={i} className={`lp-plan ${p.highlight ? "lp-plan--highlight" : ""}`}>
                ...
                >
                  {p.highlight ? "Get Started" : "Get Started"}
                </button>
              </div>
            ))}
          </div>
