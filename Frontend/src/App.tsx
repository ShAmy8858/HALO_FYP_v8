...
// SignUp removed — manager accounts are created through hospital registration
        ...
        <AuthProvider>
          <Routes>
            ...
            <Route path="/admin" element={<ProtectedRoute role="ADMIN"><AdminLayout /></ProtectedRoute>}>
              ...
              <Route path="payment-reviews" element={<PaymentReview />} />
              <Route path="profile" element={<AdminProfile />} />
            </Route>

            {/* Hospital Manager Routes */}
            <Route path="/hospital" element={<ProtectedRoute role="MANAGER"><HospitalLayout /></ProtectedRoute>}>
